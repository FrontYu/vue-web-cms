<template>
  <div>
    ...
    <drawer width="260px" :show.sync="drawerVisibility" show-mode="push" placement="left" :drawer-style="{'background-color':'#39f', width:'260px'}">
      <!-- slide bar -->
      <div slot="drawer">
        <profile></profile>
      </div>
      ...
      <view-box ref="viewBox" body-padding-top="46px">
        ...
        :title="location.name"
        :left-options="{backText: '', showBack: userLevel(6), preventGoBack: true}" @on-click-back="goUrl">

          <span slot="overwrite-left" @click="drawerVisibility = !drawerVisibility" v-if="this.$store.state.userType != 6">
            <x-icon type="navicon" size="35" style="fill:#fff;position:relative;top:-8px;left:-3px;"></x-icon>
          </span>

          <span slot="right" @click="showQrLst()">
            <img src="../assets/images/icon-scan.png" width="20" height="20">
          </span>
        </x-header>
...
<script>
import { Drawer, ViewBox, XHeader, Group, Cell, Scroller, Rater, Flexbox, FlexboxItem, Popup, XTable } from 'vux'
